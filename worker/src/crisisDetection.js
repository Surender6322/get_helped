...
// We duplicate it here (rather than import from the client) so the Worker
// is fully self-contained and can be deployed without bundling the client app.
...
const HIGH_BUCKETS = [
  ['en', HIGH_EN], ['hinglish', HIGH_HINGLISH], ['hi', HIGH_HI],
  ['ta', HIGH_TA], ['bn', HIGH_BN], ['mr', HIGH_MR],
];
const MEDIUM_BUCKETS = [
  ['en', MEDIUM_EN], ['hinglish', MEDIUM_HINGLISH], ['hi', MEDIUM_HI],
];
